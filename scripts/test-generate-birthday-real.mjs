...
// Foto enviada pelo cliente (Morena de cabelo preto)
...
async function generateBirthdayPhotoshoot() {
  console.log('Gerando foto REAL ultra-realista de aniversário com o rosto da cliente...');
