...
async function testGenerateSingle() {
  console.log('Gerando 1 foto real da cliente com Flux PuLID...');

  const prompt = 'Award-winning high-end studio portrait of the subject, celebrating 30th birthday, wearing an elegant dress, holding golden birthday candles sparklers, warm studio lighting with soft bokeh background, photorealistic, 8k resolution, highly detailed skin texture, realistic eye reflections, shot on 85mm f/1.4 lens';
